...
const FEATURE_ITEMS = [
  ...
  { icon: "stats-chart", lib: "Ionicons", title: "Stats", subtitle: "Grades", route: "/student/AcademicDashboard", color: "#22C55E", bg: "#EDFAF3" },
...
export default function StudentHome() {
  ...
  // Sync Stats with Weekly Goals Collection
  useEffect(() => {
