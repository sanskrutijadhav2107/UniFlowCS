...
// //           <FeatureCard icon={<MaterialIcons name="menu-book" size={28} color="#146ED7" />} title="Notes" subtitle="Learn anytime" />
// //           <FeatureCard icon={<Ionicons name="notifications" size={28} color="#146ED7" />} title="Notice Board" subtitle="Stay Updated" />
// //           <FeatureCard icon={<Ionicons name="calendar" size={28} color="#146ED7" />} title="TimeTable" subtitle="Know what next" />
// //           <FeatureCard icon={<Ionicons name="stats-chart" size={28} color="#146ED7" />} title="Dashboard" subtitle="Track your progress" />
// //           <FeatureCard icon={<FontAwesome5 name="trophy" size={28} color="#146ED7" />} title="Leaderboard" subtitle="Be the best" />
// //           <FeatureCard icon={<MaterialIcons name="work" size={28} color="#146ED7" />} title="Project" subtitle="Build success" />
// //         </View>
...
// //         <Ionicons name="home" size={28} color="#146ED7" />
// //         <Ionicons name="document-text" size={28} color="#146ED7" />
// //         <Ionicons name="add-circle" size={40} color="#146ED7" />
// //         <FontAwesome5 name="trophy" size={28} color="#146ED7" />
// //         <Ionicons name="person" size={28} color="#146ED7" />
// //       </View>
// //     </View>
// //   );
// // }
...
// //   header: { fontSize: 20, fontWeight: "bold", color: "#146ED7", textAlign: "center", marginVertical: 10 },
// //   gpaCard: {
...
// //   gpaBar: { height: 10, backgroundColor: "#ccc", borderRadius: 5, marginTop: 5, width: "80%" },
...
// //   featureCard: {
// //     width: "40%", backgroundColor: "#EAF3FF", padding: 15, borderRadius: 10,
// //     alignItems: "center", marginVertical: 8
// //   },
// //   featureTitle: { fontWeight: "bold", marginTop: 5 },
// //   featureSubtitle: { fontSize: 12, color: "#555", textAlign: "center" },
// //   postCard: { backgroundColor: "#fff", padding: 10, margin: 10, borderRadius: 10, borderWidth: 1, borderColor: "#ddd" },
...
// //     backgroundColor: "#fff", paddingVertical: 8, borderTopWidth: 1, borderColor: "#ddd"
// //   }
// // });
...
//     onPress={() => console.log("Notice Board clicked")}
//   />
//   <FeatureCard
//     icon={<Ionicons name="calendar" size={28} color="#146ED7" />}
//     title="TimeTable"
//     subtitle="Know what next"
//     onPress={() => console.log("Timetable clicked")}
//   />
//   <FeatureCard
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 90 }}>
        ...
        <View style={styles.grid}>
          ...
          <FeatureCard
            ...
            title="Notice Board"
            subtitle="Stay Updated"
            onPress={() => router.push("/student/notice-board")}
          />
          <FeatureCard
            icon={<Ionicons name="calendar" size={28} color="#146ED7" />}
            title="TimeTable"
